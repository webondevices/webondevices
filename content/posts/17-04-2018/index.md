...
If you wish install this on **Linux** or have any other issues, just refer to the rest of the installation guide:
...
Once the installation completed, load and initialise the new libraries in a new file called temp-log-aws.js:
...
Here, the two most important things to remember are that:
 - the **TableName** will need to be the name of the table you created in DynamoDB,
